...
public class FeedServerServiceContext extends DefaultServiceContext {
  @Override
  protected String getDefaultProviderManager() {
    return FeedServerProviderManager.class.getName();
  }

  @Override
  protected String getDefaultTargetResolver() {
    return FeedServerTargetResolver.class.getName();
  }
}