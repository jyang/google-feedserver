 ...
 *
 * Usage: fsct dirPublicGadgets <flags ...> 
 */
public class DirPublicGadgets extends GadgetCommand {

  public static final int MAX_ITERATIONS = 2;

  public DirPublicGadgets(GoogleService service, FileUtil fileUtil) {
    super(service, fileUtil);
  }

  @Override
  public void execute(String[] args) throws Exception {
    for (int startIndex = 1, iteration = 0; iteration < MAX_ITERATIONS ;
        startIndex += 20, iteration++) {
      String gadgetDirectoryUrl = getDomainFeedUrl(GADGET) +
  ...
  public void usage(boolean inShell) {
    ...
    System.out.println("    Lists gadgets in domain's public gadget directory");
  }
}
