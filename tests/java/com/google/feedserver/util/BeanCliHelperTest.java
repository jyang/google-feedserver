...
public class BeanCliHelperTest extends TestCase {
  ...
  // Test data
  public static final String testBeanConfFile =
      "<entity>\n" + "<option1>test1</option1>\n" + "<option2>test2</option2>\n"
          + "<intOption3>3</intOption3>\n" + "<boolOption4>true</boolOption4>\n" + "</entity>";

  public static final String brokenIntegerConfFile =
      "<entity>\n" + "<option1>test1</option1>\n" + "<option2>test2</option2>\n"
          + "<intOption3>dafsa</intOption3>\n" + "<boolOption4>true</boolOption4>\n" + "</entity>";

  public static final String brokenBooleanConfFile =
      "<entity>\n" + "<option1>test1</option1>\n" + "<option2>test2</option2>\n"
          + "<intOption3>3</intOption3>\n" + "<boolOption4>asdfsaf</boolOption4>\n" + "</entity>";

  public static final String brokenXmlConfFile =
      "<entity>\n" + "<broken>\n" + "<option1>test1</option1>\n" + "<option2>test2</option2>\n"
          + "<intOption3>dafsa</intOption3>\n" + "<boolOption4>true</boolOption4>\n" + "</entity>";

  public static final String[] testArgs =
      {"--option1", "clitest1", "--option2", "clitest2", "--intOption3", "6", "--noboolOption4"};

  public static final String[] incompleteArgs =
      {"--confFile", "/some/fake/path/to/a/file", "--option1", "clitest1", "--noboolOption4"};

  public static final String[] extraArgs =
      {"--option1", "clitest1", "--option2", "clitest2", "--intOption3", "clidafsa", "--extraArg",
          "imextrawoot", "--boolOption4"};

  public static final String[] confFileOnly = {"--confFile", "/some/fake/path/to/a/file"};
