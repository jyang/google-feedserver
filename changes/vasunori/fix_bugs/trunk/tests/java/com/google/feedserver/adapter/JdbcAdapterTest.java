...
public class JdbcAdapterTest extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    properties.put(AbstractAdapter.PROP_NAME_FEED_URI, "http://localhost:9090/contact");
    properties.put(AbstractAdapter.PROP_NAME_TITLE, "title");
    String id_str = properties.getProperty(AbstractAdapter.PROP_NAME_FEED_URI) + "1";
    final IRI id_iri = new IRI(id_str);
